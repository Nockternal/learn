...
function draw()
{
	...
	// if robot reaches edge change state
	if(robot1_x > 500)
	{
		robot1StateX = 1;
	...
	{
		robot1StateY = 1;
		console.log(robot1_y)
	}
	if(robot2_x > 500)
	{
		robot2StateX = 1;
		console.log(robot2_x)
	}
	if(robot2_y > 600)
	{
		robot2StateY = 1;
		console.log(robot2_y)
	}
	...
	//console.log(round(robot1_x),"---", round(robot1_y),"---", round(robot2_x),"---",round(robot2_y),"---");
}