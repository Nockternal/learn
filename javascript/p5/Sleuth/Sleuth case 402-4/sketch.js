...
Officer: 3337827
CaseNum: 402-3-41352182-3337827
...
function draw()
{
	...
	if (det.locationY < 260 && det.locationX == 700)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
	...
	if ((det.locationY < 446 && det.locationY > 250) && det.locationX == 260)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
	
	if (det.locationY == 446)
	{
		det.speedX = 1;
		det.speedY = 0;
	}

	if ((det.locationY < 448 && det.locationY > 443) && det.locationX == 826)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
	
	if (det.locationY == 570)
	{
		det.speedX = -1;
		det.speedY = 0;
	}
	
	if ((det.locationY > 565 && det.locationY < 632) && det.locationX == 450)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
	...
	if ((det.locationY > 631 && det.locationY < 703) && det.locationX == 762)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
