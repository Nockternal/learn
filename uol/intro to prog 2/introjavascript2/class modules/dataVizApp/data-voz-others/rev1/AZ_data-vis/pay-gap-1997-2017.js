  ...
  this.draw = function() {
    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      var current = {
        ...
        // 'year': ???,
        year: this.mapYearToWidth(parseInt(this.data.getString(i, 0), 10)),
        // 'payGap': ???
        payGap: this.mapPayGapToHeight(this.data.getNum(i, 3)),
      };
      ...
      if (previous != null) {
        ...
        stroke(0);
        // line( ??? );
        line(previous.year, previous.payGap, current.year, current.payGap);
