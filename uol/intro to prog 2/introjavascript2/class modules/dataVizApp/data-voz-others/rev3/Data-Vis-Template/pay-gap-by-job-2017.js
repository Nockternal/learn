function PayGapByJob2017() {
  ...
  this.draw = function() {
    ...
    for (i = 0; i < this.data.getRowCount(); i++) {
      ...
      ellipse(
        map(x, propFemaleMin, propFemaleMax, this.pad, width - this.pad),
        map(y, payGapMin, payGapMax, height - this.pad ,this.pad),
        map(size, numJobsMin, numJobsMax,   this.dotSizeMin ,   this.dotSizeMax)
      );
    }
