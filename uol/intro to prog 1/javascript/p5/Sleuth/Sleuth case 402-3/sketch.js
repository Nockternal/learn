...
Officer: 3337827
CaseNum: 402-2-40636644-3337827
...
function draw()
{
	...
	if (det.locationX == 261 && det.locationY < 320)
	{
		det.speedX = 0;
		det.speedY = 1;
	}

	if (det.locationX < 575 && det.locationY == 320)
	{
		det.speedX = 1;
		det.speedY = 0;
	}

	if (det.locationX == 575 && det.locationY < 510)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
	if (det.locationX < 889 && det.locationY == 510)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
	if (det.locationX == 889 && det.locationY < 638)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
