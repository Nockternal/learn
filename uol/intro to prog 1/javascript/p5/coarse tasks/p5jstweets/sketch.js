...
w=0,s=900;function setup(){createCanvas(s,s)}function draw(){triangle(w*1.22%255,w*2.3%255,w*3.4%255,w*4.5%255,w*5.6%255,w*6.7%255);line((w++>>10)%20,10,w++%10,20);fill(w*.22%255,w*.3%255,w*.4%255)}